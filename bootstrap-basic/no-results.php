...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php _e('Ничего не найдено', 'bootstrap-basic'); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content row-with-vspace">
		...
		<?php } elseif (is_search()) { ?> 
			<p><?php _e('Извините, но ничто не соответствовало вашим условиям поиска. Пожалуйста, попытайтесь снова с другими ключевыми словами.', 'bootstrap-basic'); ?></p>
